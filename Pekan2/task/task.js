 ...
 */
 const users = [
  { name: "Seli Mulyani", age: 20, major: "Informatika"},
  { name: "Syadiah Nur Fawaz", age: 20, major: "Informatika"},
  { name: "Alfi Syahri", age: 22, major: "Informatika"},
  { name: "Najwa", age: 19, major: "Informatika"},
  { name: "Husnah", age: 23, major: "Informatika"}
];
